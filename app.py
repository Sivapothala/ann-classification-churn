...
geography = st.selectbox('Geography', labl_encoder_geo.categories_[0])
gender = st.selectbox('Gender', labl_encoder_gender.classes_)
...
input_data = pd.DataFrame({
    ...
    'Gender': [labl_encoder_gender.transform([gender])[0]],
    'Age':[age],
    'Tenure':[tenure],
    'Balance' : [balance],
...
geo_encoded = labl_encoder_geo.transform([[geography]]).toarray()
...
if prediction_proba > 0.5:
    ...
    st.write('The customer is not likely to churn it')